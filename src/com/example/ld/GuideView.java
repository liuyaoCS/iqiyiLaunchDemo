...
//import com.example.ld.MainActivity;
//import com.example.ld.ScreenUtils;
//import com.example.ld.MainActivity.MyPagerAdapter;
...
public class GuideView extends View implements OnPageChangeListener {
	...
	public GuideView(Context context) {
		...
		mcontext=context;
		initContentView((Activity)mcontext);
	}
	public interface GuideFinishedCallBack {
		
		public static enum UserOption {
			LIST_STYLE, POSTER_STYLE;
		}

		void onGuideFinished(UserOption userOption);
	}
//	public View getView(Activity mActivity, GuideFinishedCallBack guideFinishedCallBack) {
//		if (contentView == null) {
//			initContentView(mActivity, guideFinishedCallBack);
//		}
//		return contentView;
//	}

	private void initContentView(final Activity mActivity) {

		contentView = View.inflate(mActivity, R.layout.activity_main, null);
		...
		slidingdot_layout=(RelativeLayout) contentView.findViewById(R.id.slidingdot_layout);
		slidingdot_layout.setVisibility(View.INVISIBLE);
		sliding=(ImageView) contentView.findViewById(R.id.sliding);
		sliding.setVisibility(View.INVISIBLE);
		
		View view1 = LayoutInflater.from(mActivity).inflate(
		...
		View view2 = LayoutInflater.from(mActivity).inflate(
		...
		View view3 = LayoutInflater.from(mActivity).inflate(
		...
		v3_button.setOnClickListener(new OnClickListener(){
			...
			@Override
			public void onClick(View v) {
//				if(guideFinishedCallBack != null){
//					//guideFinishedCallBack.onGuideFinished(poster_index == 0 ? UserOption.LIST_STYLE : UserOption.POSTER_STYLE);
//				}
			}
...
//				int v1_boo_left=heightAdapt(114, HeightPx);
//				int v1_plane_left=heightAdapt(227,  HeightPx);
//				int v1_line_left=heightAdapt(127, HeightPx);
...
//			}}, 1000);
	...
	private void initAnimation(Activity mActivity) {
		animationV1_Ball = AnimationUtils.loadAnimation(mActivity, R.anim.v1_ball_anim);				
		animationV1_People = AnimationUtils.loadAnimation(mActivity, R.anim.v1_people_anim);				
		animationV1_Text1 = AnimationUtils.loadAnimation(mActivity, R.anim.v12_text_anim);				
		animationV1_Text2 = AnimationUtils.loadAnimation(mActivity, R.anim.v12_text_anim);						
		animationV1_Plane = AnimationUtils.loadAnimation(mActivity, R.anim.v1_plane_anim);	
		animationV1_Line = AnimationUtils.loadAnimation(mActivity, R.anim.v1_line_anim);	
		animationV1_Cloud1 = AnimationUtils.loadAnimation(mActivity, R.anim.v1_cloud_anim1);
		...
		animationV2_Glass = AnimationUtils.loadAnimation(mActivity, R.anim.v2_glass_anim);
		animationV2_Star = AnimationUtils.loadAnimation(mActivity, R.anim.v2_star_anim);
		animationV2_Cloud1 = AnimationUtils.loadAnimation(mActivity, R.anim.v2_cloud_anim1);				
		animationV2_Cloud2 = AnimationUtils.loadAnimation(mActivity, R.anim.v2_cloud_anim2);		
		animationV2_Rotate = AnimationUtils.loadAnimation(mActivity, R.anim.v2_rotate_anim);				
		animationV2_Text1 = AnimationUtils.loadAnimation(mActivity, R.anim.v12_text_anim);		
		animationV2_Text2 = AnimationUtils.loadAnimation(mActivity, R.anim.v12_text_anim);
		...
		animationV3_moon = AnimationUtils.loadAnimation(mActivity, R.anim.v3_moon_anim);
		animationV3_bk = AnimationUtils.loadAnimation(mActivity, R.anim.v3_moon_anim);
		animationV3_cloud1 = AnimationUtils.loadAnimation(mActivity, R.anim.v3_cloud1_anim);
		animationV3_cloud2 = AnimationUtils.loadAnimation(mActivity, R.anim.v3_cloud2_anim);
		animationV3_lamp = AnimationUtils.loadAnimation(mActivity, R.anim.v3_lamp_anim);	
		animationV3_light = AnimationUtils.loadAnimation(mActivity, R.anim.v3_light_anim);				
		animationV3_text1 = AnimationUtils.loadAnimation(mActivity, R.anim.v3_text_anim);				
		animationV3_text2 = AnimationUtils.loadAnimation(mActivity, R.anim.v3_text_anim);
		animationV3_list_button = AnimationUtils.loadAnimation(mActivity, R.anim.v3_text_anim);
		animationV3_poster_button = AnimationUtils.loadAnimation(mActivity, R.anim.v3_text_anim);
		animationV3_button = AnimationUtils.loadAnimation(mActivity, R.anim.v3_button_anim);
...
//					v3_button_light.startAnimation(animationV3_button);
	...
	private void animal(int position) {
		...
		case 1:
			...
			if(v1_cloud_animationDrawable != null)
		...
		case 2:
			...
			int v3_lamp_left=heightAdapt(12,  HeightPx);
